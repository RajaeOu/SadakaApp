...
//   //   fetch('http://localhost:3000/annoces') // Assurez-vous d'utiliser le bon chemin d'accès à votre endpoint
...
//         contentFit="cover"
//         source={require("../../assets/images/mesannonces.jpg")}
//       />
...
// <View>
//             <Image
//               style={[styles.iconEditTwo, styles.iconPosition]}
//               contentFit="cover"
//               source={require('../../assets/images/list1.png')}
//             />
//               <Image
//             style={[styles.iconDelete, styles.iconLayout]}
//             contentFit="cover"
...
//           />
//            <Image
//               style={[styles.iconViewList, styles.iconPosition]}
//               contentFit="cover"
//               source={require('../../assets/images/edit.png')}
//             />
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <View style={[styles.iconSearchParent, styles.groupIconPosition]}>
          <View style={styles.groupChildShadowBox} />
          {annonces.map((annonce, index) => (
            <View key={index} style={{ marginTop: index > 0 ? 90 : 0 }}>
              <View style={[styles.clock, styles.clockPosition]}>
                <Image
                  style={[styles.listIcon, styles.text2Position]}
                  contentFit="cover"
              ...
              <Text style={[styles.quantity, styles.dateTypo]}>{annonce.quantite}</Text>
              {/* <View style={[styles.calendarblankIcon, styles.clockPosition]}> */}

              <Link href={"/tab2/connecter"}><Image
                contentFit="cover"
                source={require('../../assets/images/list1.png')}
                style={[styles.calendarblankIcon, styles.clockPosition]}
              /></Link>
              <Link href={"/tab2/connecter"}><View style={styles.container3}>
                <Image
                  source={require('../../assets/images/fleche.png')}
                  style={styles.image2}
                />
              </View></Link>
              <Link href={"/tab2/connecter"}> 
              <Image
                contentFit="cover"
                source={require('../../assets/images/edit.png')}
                style={[styles.calendarblankIcon, styles.clockPosition1]}
              />
              </Link> 
              ...
              <Image
                contentFit="cover"
                source={require('../../assets/images/delete1.png')}
                style={[styles.calendarblankIcon, styles.clockPosition3]}
              /></Link>
